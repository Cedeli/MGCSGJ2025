...
public partial class Game : Node3D
{
	...
	[Export]
	private float _roundDurationSeconds = 30.0f;

	[Export]
	private int _initialAlienCount = 5;

	[Export]
	private int _alienIncreasePerRound = 3;

	[Export]
	private int _alienScoreValue = 10;
